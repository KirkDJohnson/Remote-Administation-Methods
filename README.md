<h1>Windows Remote Administration and Assistance Methods</h1>

<br />
<h2>Description</h2>
This is a continuation of the project, "Installing Active Directory", and "Configuring and Troubleshooting Active Directory". In this part of the project, I explore different means of remote access, assistance, and administration from the user helpdesk, on Lab-Desktop-2 to user john smith on Desktop2 with the previously built Active Directory domain. I gain hands on experience with both native to Windows and some third party solutions. For example, within the private domain environment, I sucessfully connected helpdesk to john smith via: Remote Desktop (RDP), remote registry from regedit, view and edit the file system via file explorer with "\\Desktop2\C$", and Windows Remote Assistance. For the third party tools, I experimented with Spiceworks's Zoho Assist, and PDQ's Deploy and Inventory to remotely deploy applications and obtain reports from the end user's machine without disrupting their workflow.<br/>
